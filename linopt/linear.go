...
func FromCanonical[T constraints.Signed](form CanonicalForm[T]) LinearProgram[T] {
	return FromStandard(form.ToStandard())
}

// FromCanonical converts from StandardForm to LinearProgram.
func FromStandard[T constraints.Signed](form StandardForm[T]) LinearProgram[T] {
